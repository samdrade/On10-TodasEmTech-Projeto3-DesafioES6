...
const input = document.querySelector("#nomeDoUsuario");
...
const getUsuario = async (usuario) => {
   ...
   try {
    ...
    profile.innerHTML = criarCardNotFound()
   }
...
criarCardNotFound = () => {
    ...
    <section class="errorMessage">
        <h1 class="errorMessage__titulo">Usuário não encontrado :(</h1>
        <p class="errorMessage__paragrafo">Pesquise novamente</p>
        <img class="errorMessage__img" src="../../images/not-found.svg" alt="Imagem de erro">
      </section>  
`
}
